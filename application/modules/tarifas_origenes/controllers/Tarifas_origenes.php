...
class Tarifas_origenes  extends MX_Controller
{
    private $nameClass;
    private $icono;
    private $proyecto;
	...
	public function index()
	{
        ...
        $data['getResult'] = $this->doctrine->em->getRepository("Entities\\Tarorigenes")->findAll();
    ...
    public function add()
    {
        ...
        if(isset($_POST['submit']))
        {
            ...
            if ($this->form_validation->run())
            {
                ...
                $grupo = new Entities\Tarorigenes;
                //seteamos los datos
    ...
    public function edit($id)
    {
        ...
        $data['getRow'] = $this->doctrine->em->find("Entities\\Tarorigenes", $id);
        //comprobamos formulario submit
        if(isset($_POST['submit']))
        {
            //validamos los datos
    ...
    public function delete($id)
    {
        ...
        $getRow = $this->doctrine->em->getRepository("Entities\\Tarorigenes")->findOneBy(["id" => $id]);
        //eliminamos el item
