...
class Tarifas_paquetes  extends MX_Controller
{
    private $nameClass;
    private $icono;
    private $proyecto;
	...
	public function index()
	{
        ...
        $data['getResult'] = $this->doctrine->em->getRepository("Entities\\Tarpaquetes")->findAll();
    ...
    public function add()
    {
        ...
        if(isset($_POST['submit']))
        {
            ...
            if ($this->form_validation->run())
            {
                ...
                $grupo = new Entities\Tarpaquetes;
                //seteamos los datos
    ...
    public function edit($id)
    {
        ...
        $data['getRow'] = $this->doctrine->em->find("Entities\\Tarpaquetes", $id);
        //comprobamos formulario submit
        if(isset($_POST['submit']))
        {
            //validamos los datos
    ...
    public function delete($id)
    {
        ...
        $getRow = $this->doctrine->em->getRepository("Entities\\Tarpaquetes")->findOneBy(["id" => $id]);
        //eliminamos el item
