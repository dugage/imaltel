...
class Tarifas_grupos  extends MX_Controller
{
    private $nameClass;
    private $icono;
    private $proyecto;
	...
	public function index()
	{
        ...
        $data['getResult'] = $this->doctrine->em->getRepository("Entities\\Targrupos")->findAll();
    ...
    public function edit($id)
    {
        ...
        $data['getRow'] = $this->doctrine->em->find("Entities\\Targrupos", $id);
        //comprobamos formulario submit
        if(isset($_POST['submit']))
        {
            //validamos los datos
    ...
    public function delete($id)
    {
        ...
        $getRow = $this->doctrine->em->getRepository("Entities\\Targrupos")->findOneBy(["id" => $id]);
        //eliminamos el item
