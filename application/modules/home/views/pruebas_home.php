                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th width="10%"></th>
                                    <th class="numeric" colspan="5"> LUNES </th>
                                    <th class="numeric" colspan="5"> MARTES </th>
                                    <th class="numeric" colspan="5"> MIERCOLES </th>
                                    <th class="numeric" colspan="5"> JUEVES </th>
                                    <th class="numeric" colspan="5"> VIERNES </th>
                                    <th class="numeric" colspan="5"> OBJETIVOS </th>
                                    <th class="numeric" colspan="5"> CONSECUCIÓN </th>
                                    <th class="numeric" colspan="5"> QUEDAN </th>
                                    <th class="numeric" colspan="5"> % </th>
                                    </tr>
                                <tr>
                                    <th width="10%">COMERCIAL</th>

                                    <th class="numeric"> N </th>
                                    <th class="numeric"> OF </th>
                                    <th class="numeric"> C </th>
                                    <th class="numeric"> KO </th>
                                    <th class="numeric"> FRM </th>
