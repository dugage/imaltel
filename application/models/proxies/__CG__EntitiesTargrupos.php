 ...
 */
class Targrupos extends \Entities\Targrupos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Targrupos' . "\0" . 'id', '' . "\0" . 'Entities\\Targrupos' . "\0" . 'nombre', '' . "\0" . 'Entities\\Targrupos' . "\0" . 'falta'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Targrupos $proxy) {
