 ...
 */
class Tartarifas extends \Entities\Tartarifas implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Tartarifas' . "\0" . 'id', '' . "\0" . 'Entities\\Tartarifas' . "\0" . 'nombre', '' . "\0" . 'Entities\\Tartarifas' . "\0" . 'falta', '' . "\0" . 'Entities\\Tartarifas' . "\0" . 'idgrupo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tartarifas $proxy) {
